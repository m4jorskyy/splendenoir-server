...
func (r *OrderRepository) CreateOrder(ctx context.Context, profileID int64, addressID int64, items []*cart.CartItem) error {
	...
	if len(products) != len(itemsMap) {
		return errors.New("some products are unavailable")
	}
